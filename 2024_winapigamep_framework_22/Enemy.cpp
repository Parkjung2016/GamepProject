...
void Enemy::Init(int _iIdleFrameCount, int _iTraceFrameCount, int _iAttackFrameCount, int _iGetHitFrameCount,
	int _iDeadFrameCount)
{
	Animator* animator = GetComponent<Animator>();
	// 9, 10, 4, 5 ,5
	animator->CreateAnimation(L"Idle", m_pTex, Vec2(0.f, 0.f),
		Vec2(96.f, 96.f), Vec2(96.f, 0.f), _iIdleFrameCount, 0.1f);
	animator->CreateAnimation(L"Trace", m_pTex, Vec2(0.f, 672.f),
		Vec2(96.f, 96.f), Vec2(96.f, 0.f), _iTraceFrameCount, 0.1f);
	animator->CreateAnimation(L"Attack", m_pTex, Vec2(0.f, 96.f),
		Vec2(96.f, 96.f), Vec2(96.f, 0.f), _iAttackFrameCount, 0.1f);
	animator->CreateAnimation(L"GetHit", m_pTex, Vec2(0.f, 0.f),
		Vec2(96.f, 96.f), Vec2(96.f, 0.f), _iGetHitFrameCount, 0.1f);
	animator->CreateAnimation(L"Dead", m_pTex, Vec2(0.f, 768.f),
		Vec2(96.f, 96.f), Vec2(96.f, 0.f), _iDeadFrameCount, 0.1f);
...
void Enemy::SetTexture(const wstring& _wKey, const wstring& _wPath)
{
